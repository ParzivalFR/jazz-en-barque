  ...
  return (
    <section className="h-full w-full bg-background flex flex-col items-center px-4">
      <div className="relative h-full w-full sm:w-4/5">
        ...
        <div className="absolute top-14 rounded-2xl w-full p-4 pt-20 sm:px-20 flex flex-col items-center gap-6 justify-start bg-lightblue ">
          <p>
            A bord vous aurez l’occasion de pouvoir participer à une parade et
            une course.. à condition de respecter le theme :
          </p>
